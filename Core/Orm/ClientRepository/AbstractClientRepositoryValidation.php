...
use Abc\Utility\Session;
use Abc\Collection\Collection;
use Abc\Utility\RandomCharGenerator;

Abstract class AbstractClientRepositoryValidation implements ClientRepositoryValidationInterface
{
     ...
     * The fields() method is an abstract method defined within AbstractClientRepositoryValidation()
                ...
                foreach ($entityCollection as $this->key => $this->value) :
                    if (isset($this->key) && $this->key != '') :
                        if (!$callback instanceof Closure) {
                            throw new Exception($callback . ' is not an instance of a closure.');
                        }
